        ...
        <div class="container">
            <div class="row m-b-lg">
                <div class="col-lg-12 text-center">
                    ...
                    <h1>Institution: <?php echo (isset($institution) && $institution && $institution['institution_name']) ? $institution['institution_name'] : ""; ?></h1>
                </div>
            </div>
            <div class="row">
    ...
    <section id="managers" class="gray-section team">
        <div class="container">
            <div class="row m-b-lg">
                <div class="col-lg-12 text-center">
                    <div class="navy-line"></div>
                    <h1>Manager: <?php echo (isset($manager) && $manager && $manager['manager_name']) ? $manager['manager_name'] : ""; ?></h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 wow fadeInLeft">
    ...
    <section id="managers" class="gray-section team">
        <div class="container">
            <div class="row m-b-lg">
                <div class="col-lg-12 text-center">
                    <div class="navy-line"></div>
                    <h1>Instrument: <?php echo (isset($instrument) && $instrument && $instrument['quote_name']) ? $instrument['quote_name'] . " [" . $instrument['quote_symbol'] . "]" : ""; ?></h1>
                </div>
            </div>
